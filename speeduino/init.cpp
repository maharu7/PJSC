...
void construct2dTables(void) {
  ...
  construct2dTable(acclAdvTable,              _countof(configPage15.acclAdvance),               configPage15.acclAdvance,               configPage15.acclAdvBins);  //[PJSC v1.10]
...
//Teensy 4.1 does not require .begin() to be called. This introduces a 700ms delay on startup time whilst USB is enumerated if it is called
    ...
    initialisePvControl();        //[PJSC v1.10] For PV control
    initialiseStarter();          //[PJSC v1.10]
...
//[PJSC v1.01]    inj_opentime_uS = configPage2.injOpen * 100; //Injector open time. Comes through as ms*10 (Eg 15.5ms = 155).

    //******************** [PJSC v1.10] ********************
    inj_opentime_uS = configPage2.injOpen * 10;   //Injector open time. Comes through as ms*10 (Eg 1.55ms = 155).

    if( configPage2.indInjAng )
    {
      inj2_opentime_uS = configPage15.injOpen2 * 10;
      inj3_opentime_uS = configPage15.injOpen3 * 10;
      inj4_opentime_uS = configPage15.injOpen4 * 10;
    }
    else
    {
      inj2_opentime_uS = configPage2.injOpen * 10;
      inj3_opentime_uS = configPage2.injOpen * 10;
      inj4_opentime_uS = configPage2.injOpen * 10;
    }
    //******************** [PJSC v1.10] ********************
    ...
    */
    ...
    else if(configPage2.strokes == TWO_STROKE){ req_fuel_uS = req_fuel_uS / 2; }   //[PJSC v1.10]
    ...
    case 2:
        ...
        //****************************** [PJSC v1.10] ******************************
        if ( (configPage4.TrigPattern == DECODER_KATANA) || (configPage4.TrigPattern == DECODER_NSR250R) || (configPage4.TrigPattern == DECODER_RGV250) )
        {
          channel1IgnDegrees -= configPage15.pickup_advance1;
          channel2IgnDegrees -= configPage15.pickup_advance2;
        }
        //****************************** [PJSC v1.10] ******************************
    ...
    case 3:
        ...
        if (configPage2.engineType == EVEN_FIRE )
        {
          ...
          //******************** [PJSC v1.10] ********************
          if( (configPage4.sparkMode == IGN_MODE_SEQUENTIAL) && (configPage2.strokes == TWO_STROKE) )
          {
...
//[PJSC v1.10]        pinInjector1 = PB7; //Output pin injector 1 is on
//[PJSC v1.10]        pinInjector2 = PB6; //Output pin injector 2 is on
//[PJSC v1.10]        pinInjector3 = PB5; //Output pin injector 3 is on
//[PJSC v1.10]        pinInjector4 = PB4; //Output pin injector 4 is on
//[PJSC v1.10]        pinCoil1 = PB9; //Pin for coil 1
//[PJSC v1.10]        pinCoil2 = PB8; //Pin for coil 2
//[PJSC v1.10]        pinCoil3 = PB3; //Pin for coil 3
//[PJSC v1.10]        pinCoil4 = PA15; //Pin for coil 4
//[PJSC v1.10]        pinTPS = A2;//TPS input pin
//[PJSC v1.10]        pinMAP = A3; //MAP sensor pin
//[PJSC v1.10]        pinIAT = A0; //IAT sensor pin
//[PJSC v1.10]        pinCLT = A1; //CLS sensor pin
//[PJSC v1.10]        pinO2 = A8; //O2 Sensor pin
//[PJSC v1.10]        pinBat = A4; //Battery reference voltage pin
//[PJSC v1.10]        pinBaro = pinMAP;
//[PJSC v1.10]        pinTachOut = PB1; //Tacho output pin  (Goes to ULN2803)
//[PJSC v1.10]        pinIdle1 = PB2; //Single wire idle control
//[PJSC v1.10]        pinIdle2 = PB10; //2 wire idle control
//[PJSC v1.10]        pinBoost = PA6; //Boost control
//[PJSC v1.10]        pinStepperDir = PB10; //Direction pin  for DRV8825 driver
//[PJSC v1.10]        pinStepperStep = PB2; //Step pin for DRV8825 driver
//[PJSC v1.10]        pinFuelPump = PA8; //Fuel pump output
//[PJSC v1.10]        pinFan = PA5; //Pin for the fan output (Goes to ULN2803)
//[PJSC v1.10]        //external interrupt enabled pins
//[PJSC v1.10]        pinFlex = PC14; // Flex sensor (Must be external interrupt enabled)
//[PJSC v1.10]        pinTrigger = PC13; //The CAS pin also led pin so bad idea
//[PJSC v1.10]        pinTrigger2 = PC15; //The Cam Sensor pin
        //************************* [PJSC v1.10] *************************
        ...
        pinIdle1 = PC7; //Single wire idle control
   ...
   case 31:
    ...
    case 70:
      //[PJSC]Pin mappings as per the PJSC ver1.0 shield (2018.03.05)
      pinInjector1 = 10;     //Output pin injector 1 is on
      ...
      pinInjector5 = 44;     //Output pin injector 5 is on
      pinCoil1 = 40;         //Pin for coil 1
      pinCoil2 = 38;         //Pin for coil 2
      ...
      pinVVT_1 = 11;         //Default VVT output
      pinFuelPump = 47;      //Fuel pump output  (Goes to ULN2803)
      pinStepperDir = 16;    //Direction pin  for DRV8825 driver
      pinStepperStep = 17;   //Step pin for DRV8825 driver
      pinStepperEnable = 24; //Enable pin for DRV8825
...
//      pinMuxout4 = 15;       //[PJSC v1.01] For MUX output setting
    ...
    case 73:
      //[PJSC]Pin mappings as per the PJSC ver1.10 SPARK PCB proto1 (2024.07.03)
      pinInjector1     = 11;     //Output pin injector 1 is on
      pinInjector2     = 10;     //Output pin injector 2 is on
      pinInjector3     = 12;     //Output pin injector 3 is on
      pinInjector4     = 13;     //Output pin injector 4 is on
      pinInjector5     = 26;     //Output pin injector 5 is on
      pinCoil1         = 38;     //Pin for coil 1
      ...
      pinExValve       = A14;    //Exhaust valve position input pin
      pinSpareTemp1    = A15;    //[PJSC v1.10] For spare thermistor input
      pinFuelPump      = 41;     //Fuel pump output  (Goes to ULN2803)
      pinDisplayReset  = 44;     //OLED reset pin
      pinTachOut       = 45;     //Tacho output pin  (Goes to ULN2803)
      pinIdle1         = 46;     //Single wire idle control                  //[PJSC v1.01]
      pinIdle2         = 47;     //2 wire idle control
      ...
      pinExtTrigger    = 2;      //[PJSC] External Trigger
      pinCaptureDuty1  = 3;      //[PJSC] For capturing duty pulse
      //pinCaptureDuty2  = 26;     //[PJSC] For capturing duty pulse
      pinResetControl  = 31;     //Reset control output
      pinMuxout1       = 4;      //[PJSC v1.01] For MUX output setting
      pinMuxout2       = 5;      //[PJSC v1.01] For MUX output setting
      pinMuxout3       = 6;      //[PJSC v1.01] For MUX output setting
      pinMuxout4       = 7;      //[PJSC v1.01] For MUX output setting
      pinMuxoutHC      = 43;     //[PJSC v1.01] For MUX output setting
      break;

    case 74:
      //[PJSC]Pin mappings as per the PJSC ver1.10 SPARK PCB proto2 (2024.10.14)
      pinInjector1     = 10;     //Output pin injector 1 is on
      pinInjector2     = 11;     //Output pin injector 2 is on
      pinInjector3     = 12;     //Output pin injector 3 is on
      pinInjector4     = 13;     //Output pin injector 4 is on
      ...
      pinMuxout4       = 7;      //[PJSC v1.01] For MUX output setting
      pinMuxoutHC      = 42;     //[PJSC v1.01] For MUX output setting
      pinPvDIR         = 41;     //[PJSC v1.10] For PV control
      pinPvPWM         = 39;     //[PJSC v1.10] For PV control
      pinPvDIS         = 43;     //[PJSC v1.10] For PV control
      break;

    case 75:
      //[PJSC]Pin mappings as per the PJSC ver1.10 SPARK PCB proto3 (2025.03.21)
      pinInjector1     = 10;     //Output pin injector 1 is on
      pinInjector2     = 11;     //Output pin injector 2 is on
      pinInjector3     = 12;     //Output pin injector 3 is on
      pinInjector4     = 13;     //Output pin injector 4 is on
  ...
  if ( (configPage15.defaultMAPPinUse != 0) && (configPage15.mapPin < BOARD_MAX_IO_PINS) ) { pinMAP = pinTranslateAnalog(configPage15.mapPin); }     //[PJSC v1.10]
...
//********** [PJSC v1.10] Setup MUX output and Analog input pins **********
  if( (configPage2.pinMapping >= 70) && (configPage2.pinMapping <= 75) )    //For PJSC ver1.0, 1.10 and SPARK board
  {
    switch (configPage15.muxout1Selection)
    {
      case MUXOUT_OFF:
        break;
      ...
      case MUXOUT_LAUNCH:
        pinLaunch = pinMuxout1;
        break;

      case MUXOUT_FUELPUMP:
        pinFuelPump = pinMuxout1;
        break;
      ...
      case MUXOUT_TACH:
        pinTachOut = pinMuxout1;
        break;

      case MUXOUT_WMI:
        pinWMIEnabled = pinMuxout1;
        break;

      case MUXOUT_OILSOLENOID:
        ;pinOilSolenoid = pinMuxout1;
        pinVVT_1 = pinMuxout1;
        break;
    ...
    switch (configPage15.muxout2Selection)
    {
      case MUXOUT_OFF:
        break;
      ...
      case MUXOUT_LAUNCH:
        pinLaunch = pinMuxout2;
        break;

      case MUXOUT_FUELPUMP:
        pinFuelPump = pinMuxout2;
        break;
      ...
      case MUXOUT_TACH:
        pinTachOut = pinMuxout2;
        break;

      case MUXOUT_WMI:
        pinWMIEnabled = pinMuxout2;
        break;
  ...
  if( (configPage2.pinMapping >= 71) && (configPage2.pinMapping <= 75) )       //For PJSC SPARK board
  {
    switch (configPage15.muxout3Selection)
    {
      ...
      case MUXOUT_LAUNCH:
        pinLaunch = pinMuxout3;
        break;

      case MUXOUT_FUELPUMP:
        pinFuelPump = pinMuxout3;
        break;
      ...
      case MUXOUT_TACH:
        pinTachOut = pinMuxout3;
        break;

      case MUXOUT_WMI:
        pinWMIEnabled = pinMuxout3;
        break;

      case MUXOUT_OILSOLENOID:
        ;pinOilSolenoid = pinMuxout3;
        pinVVT_1 = pinMuxout3;
        break;
    ...
    switch (configPage15.muxout4Selection)
    {
      case MUXOUT_OFF:
        break;
      ...
      case MUXOUT_LAUNCH:
        pinLaunch = pinMuxout4;
        break;

      case MUXOUT_FUELPUMP:
        pinFuelPump = pinMuxout4;
        break;
    ...
    switch (configPage15.muxoutHCSelection)
    {
      case MUXOUT_OFF:
        break;

      case MUXOUT_IDLE:
        pinIdle1 = pinMuxoutHC;
        break;
      ...
      case MUXOUT_LAUNCH:
        pinLaunch = pinMuxoutHC;
        break;

      case MUXOUT_FUELPUMP:
        pinFuelPump = pinMuxoutHC;
        break;

      case MUXOUT_BOOST:
        pinBoost = pinMuxoutHC;
        break;

      case MUXOUT_VVT:
        pinVVT_1 = pinMuxoutHC;
        break;

      case MUXOUT_VVT2:
        pinVVT_2 = pinMuxoutHC;
        break;

      case MUXOUT_TACH:
        pinTachOut = pinMuxoutHC;
        break;

      case MUXOUT_OILSOLENOID:
        ;pinOilSolenoid = pinMuxoutHC;
        pinVVT_1 = pinMuxoutHC;
        break;

      case MUXOUT_STARTER:
        pinStarter = pinMuxoutHC;
        break;
  ...
  if( configPage2.pinMapping == 70 )  //For PJSC ver1.0 and 1.10 board
  {
    switch (configPage15.analogInputPortSelection)
    {
      ...
      case ANALOG_EXVALVE:
        pinExValve = pinAnalogInput1;
        break;

      case ANALOG_O2_SEC:
        pinO2_2 = pinAnalogInput1;
        break;
  ...
  if( configPage2.pinMapping == 70 )
  {
    switch (configPage15.analogInputPortSelection2)                   //For PJSC ver1.0 board
    {
      case ANALOG_INPUT_OFF:
        break;
...
//********** [PJSC v1.10] Setup MUX output and Analog input pins **********
  ...
  //********** [PJSC v1.10]Digital input port pullup setting **********
  if(configPage15.pullupDigitalInput1) { digitalWrite(pinExtTrigger, HIGH); }
  if(configPage15.pullupDigitalInput2) { digitalWrite(pinCaptureDuty1, HIGH); }
  //if(configPage15.pullupDigitalInput3) { digitalWrite(pinCaptureDuty2, HIGH); }
  //********** [PJSC v1.10]Digital input port pullup setting **********
...
// #endif
  ...
  //And for inputs
      ...
      pinMode(pinExValve, INPUT_ANALOG);  //[PJSC] For External Trigger
      pinMode(pinEGT, INPUT_ANALOG);      //[PJSC] For Exhaust Gas Temperature Sensor
    #else
      ...
      pinMode(pinEGT, INPUT);             //[PJSC] For Exhaust Gas Temperature Sensor
    #endif
  #elif defined(CORE_TEENSY41)
    ...
    pinMode(pinExValve, INPUT_DISABLE);   //[PJSC] For External Trigger
    pinMode(pinEGT, INPUT_DISABLE);       //[PJSC] For Exhaust Gas Temperature Sensor
  #endif
  pinMode(pinExtTrigger, INPUT);          //[PJSC] External Trigger
  pinMode(pinCaptureDuty1, INPUT);        //[PJSC] For capturing duty pulse
  pinMode(pinCaptureDuty2, INPUT);        //[PJSC] For capturing duty pulse
  ...
  {
    if(configPage15.pullupVSS) { digitalWrite(pinVSS, HIGH); }        //[PJSC v1.10]
...
void initialiseTriggers(void)
{
  ...
  switch (configPage4.TrigPattern)
  {
    case DECODER_MISSING_TOOTH:
      ...
      //[PJSC v1.10]if(configPage10.vvt2Enabled > 0) { attachInterrupt(triggerInterrupt3, triggerTertiaryHandler, tertiaryTriggerEdge); } // we only need this for vvt2, so not really needed if it's not used
    ...
    case DECODER_NSR250R:
      //Honda NSR250R
      triggerSetup_NSR();
      triggerHandler = triggerPri_NSR;
      triggerSecondaryHandler = triggerSec_NSR;
      getRPM = getRPM_NSR;
      getCrankAngle = getCrankAngle_NSR;
      triggerSetEndTeeth = triggerSetEndTeeth_NSR;
    ...
    case DECODER_RGV250:
      // Suzuki RGV250
      triggerSetup_RGV250();
      triggerHandler = triggerPri_RGV250;
      getRPM = getRPM_RGV250;
      getCrankAngle = getCrankAngle_RGV250;
      triggerSetEndTeeth = triggerSetEndTeeth_RGV250;
...
void changeHalfToFullSync(void)
{
  ...
  noInterrupts();
//[PJSC v1.10]  if( (configPage2.injLayout == INJ_SEQUENTIAL) && (CRANK_ANGLE_MAX_INJ != 720) && (!isAnyFuelScheduleRunning()))
  if( (configPage2.injLayout == INJ_SEQUENTIAL) && (CRANK_ANGLE_MAX_INJ != 720) && fuelSchedule1.Status!=RUNNING && fuelSchedule2.Status!=RUNNING && fuelSchedule3.Status!=RUNNING && fuelSchedule4.Status!=RUNNING) //[PJSC v1.10]
  {
    CRANK_ANGLE_MAX_INJ = 720;
    req_fuel_uS *= 2;
...
//***************************************************************************************************************************
//[PJSC v1.01] For external signal input

void initialiseExternalTrigger(void)     //[PJSC] For External Trigger Interruot
{
  extTriggerInterrupt = 2;

  #if defined(CORE_AVR)
    switch (pinExtTrigger) {
      //Arduino Mega 2560 mapping
      case 2:
        extTriggerInterrupt = 0; break;
      case 3:
        extTriggerInterrupt = 1; break;
      case 18:
        extTriggerInterrupt = 5; break;
      case 19:
        extTriggerInterrupt = 4; break;
      case 20:
        extTriggerInterrupt = 3; break;
      case 21:
        extTriggerInterrupt = 2; break;
      default:
        extTriggerInterrupt = 0; break; //This should NEVER happen
    }
  #else
    extTriggerInterrupt = pinExtTrigger;
  #endif
...
void changeMapSelectSw(void)             //[PJSC v1.01] For MAP switch
{
  currentStatus.mapSelectSw = digitalRead(pinExtTrigger);
}

void initialiseCaptureDutyPulse(void)     //[PJSC] For capturing duty pulse
{
  captureDutyPulseInterrupt = 1;

  #if defined(CORE_AVR)
    switch (pinCaptureDuty1) {
      //Arduino Mega 2560 mapping
      case 2:
        captureDutyPulseInterrupt = 0; break;
      case 3:
        captureDutyPulseInterrupt = 1; break;
      case 18:
        captureDutyPulseInterrupt = 5; break;
      case 19:
        captureDutyPulseInterrupt = 4; break;
      case 20:
        captureDutyPulseInterrupt = 3; break;
      case 21:
        captureDutyPulseInterrupt = 2; break;
      default:
        captureDutyPulseInterrupt = 0; break; //This should NEVER happen
    }
  #else
    captureDutyPulseInterrupt = pinCaptureDuty1;
  #endif
...
void initialiseCaptureDutyPulse2(void)    //[PJSC] For capturing duty pulse
{
  captureDutyPulseInterrupt2 = 1;

  #if defined(CORE_AVR)
    switch (pinCaptureDuty2) {
      //Arduino Mega 2560 mapping
      case 2:
        captureDutyPulseInterrupt2 = 0; break;
      case 3:
        captureDutyPulseInterrupt2 = 1; break;
      case 18:
        captureDutyPulseInterrupt2 = 5; break;
      case 19:
        captureDutyPulseInterrupt2 = 4; break;
      case 20:
        captureDutyPulseInterrupt2 = 3; break;
      case 21:
        captureDutyPulseInterrupt2 = 2; break;
      default:
        captureDutyPulseInterrupt2 = 0; break; //This should NEVER happen
    }
  #else
    captureDutyPulseInterrupt2 = pinCaptureDuty2;
  #endif

  pinMode(pinCaptureDuty2, INPUT);
