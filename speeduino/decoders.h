...
void triggerSetup_NSR();          //[PJSC ver1.02] For supporting NSR trigger
void triggerPri_NSR();            //[PJSC ver1.02] For supporting NSR trigger
void triggerSec_NSR();            //[PJSC ver1.02] For supporting NSR trigger
uint16_t getRPM_NSR();            //[PJSC ver1.02] For supporting NSR trigger
int getCrankAngle_NSR();          //[PJSC ver1.02] For supporting NSR trigger
void triggerSetEndTeeth_NSR();    //[PJSC ver1.02] For supporting NSR trigger

void triggerSetup_KATANA();       //[PJSC ver1.02] For supporting KATANA trigger
void triggerPri_KATANA();         //[PJSC ver1.02] For supporting KATANA trigger
void triggerSec_KATANA();         //[PJSC ver1.02] For supporting KATANA trigger
uint16_t getRPM_KATANA();         //[PJSC ver1.02] For supporting KATANA trigger
...
volatile unsigned long trigger12FilterTime;  //[PJSC v1.02]
