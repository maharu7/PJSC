...
#include "maths.h"
#include "utilities.h"
#include "speeduino.h"         //[PJSC v1.10]
#include BOARD_H 
...
byte getTSLogEntry(uint16_t byteNum)
{
  ...
  switch(byteNum)
  {
    ...
    [PJSC v1.10] Omitto Ari conditoner controll */
    //****************** [PJSC v1.10] ******************
    case 124: statusValue = lowByte(currentStatus.actualDwell); break;
    case 125: statusValue = highByte(currentStatus.actualDwell); break;
    case 126: statusValue = currentStatus.status5; break;
    case 127: statusValue = currentStatus.knockCount; break;
    case 128: statusValue = currentStatus.knockRetard; break;
    case 129: statusValue = currentStatus.PVPosition; break;
    case 130: statusValue = lowByte(currentStatus.PVPositionADC); break;
    case 131: statusValue = highByte(currentStatus.PVPositionADC); break;
    case 132: statusValue = currentStatus.inj1VE; break;
    case 133: statusValue = currentStatus.inj2VE; break;
    case 134: statusValue = currentStatus.inj3VE; break;
    case 135: statusValue = currentStatus.inj4VE; break;
    case 136: statusValue = lowByte(dutyFreq); break;
    case 137: statusValue = highByte(dutyFreq); break;
    case 138: statusValue = lowByte(dutyFreq2); break;
    case 139: statusValue = highByte(dutyFreq2); break;
    case 140: statusValue = lowByte(dutyRatio); break;
    case 141: statusValue = highByte(dutyRatio); break;
    case 142: statusValue = lowByte(dutyRatio2); break;
    case 143: statusValue = highByte(dutyRatio2); break;
    case 144: statusValue = lowByte(extTriggerAngle); break;
    case 145: statusValue = highByte(extTriggerAngle); break;
    case 146: statusValue = lowByte(extTriggerAngle2); break;
    case 147: statusValue = highByte(extTriggerAngle2); break;
    case 148: statusValue = lowByte(currentStatus.EGTADC); break;
    case 149: statusValue = highByte(currentStatus.EGTADC); break;
    case 150: statusValue = lowByte(currentStatus.fuelLoad3); break;
    case 151: statusValue = highByte(currentStatus.fuelLoad3); break;
    case 152: statusValue = lowByte(currentStatus.fuelLoad4); break;
    case 153: statusValue = highByte(currentStatus.fuelLoad4); break;
    case 154: statusValue = lowByte(extTriggerRPM); break;
    case 155: statusValue = highByte(extTriggerRPM); break;
    case 156: statusValue = lowByte(extTriggerLoad); break;
    case 157: statusValue = highByte(extTriggerLoad); break;
    case 158: statusValue = lowByte(currentStatus.testCnt); break;
    case 159: statusValue = highByte(currentStatus.testCnt); break;
    case 160: statusValue = lowByte(ignGap); break;
    case 161: statusValue = highByte(ignGap); break;
    case 162: statusValue = lowByte((int)(currentStatus.MAP10)); break;
    case 163: statusValue = highByte((int)(currentStatus.MAP10)); break;
    case 164: statusValue = lowByte((int)(currentStatus.baro10)); break;
    case 165: statusValue = highByte((int)(currentStatus.baro10)); break;
    case 166: statusValue = misfireDetectionCount; break;
    case 167: statusValue = currentStatus.egoCorrection; break; //Exhaust gas correction (%)
    case 168: statusValue = lowByte(currentStatus.corrections2); break; //Total GammaE (%)
    case 169: statusValue = highByte(currentStatus.corrections2); break; //Total GammaE (%)
    case 170: statusValue = currentStatus.accelAdvance; break; //Accel Advance
    //case 171: statusValue = lowByte(indexRatio); break; //[For Debug] Index trigger ratio for KATANA
    //case 172: statusValue = highByte(indexRatio); break; //[For Debug] Index trigger ratio for KATANA
    //****************** [PJSC v1.10] ******************
...
int16_t getReadableLogEntry(uint16_t logIndex)
{
  ...
  switch(logIndex)
  {
    ...
    [PJSC v1.10] Omitto Ari conditoner controll */
   //****************** [PJSC v1.10] ******************
    case 89: statusValue = currentStatus.actualDwell; break;
    case 90: statusValue = currentStatus.status5; break;
    case 91: statusValue = currentStatus.knockCount; break;
    case 92: statusValue = currentStatus.knockRetard; break;
    case 93: statusValue = currentStatus.PVPosition; break;
    case 94: statusValue = currentStatus.PVPositionADC; break;
    case 95: statusValue = currentStatus.inj1VE; break;
    case 96: statusValue = currentStatus.inj2VE; break;
    case 97: statusValue = currentStatus.inj3VE; break;
    case 98: statusValue = currentStatus.inj4VE; break;
    case 99: statusValue = dutyFreq; break;
    case 100: statusValue = dutyFreq2; break;
    case 101: statusValue = dutyRatio; break;
    case 102: statusValue = dutyRatio2; break;
    case 103: statusValue = extTriggerAngle; break;
    case 104: statusValue = extTriggerAngle2; break;
    case 105: statusValue = currentStatus.EGTADC; break;
    case 106: statusValue = currentStatus.fuelLoad3; break;
    case 107: statusValue = currentStatus.fuelLoad4; break;
    case 108: statusValue = extTriggerRPM; break;
    case 109: statusValue = extTriggerLoad; break;
    case 110: statusValue = currentStatus.testCnt; break;
    case 111: statusValue = ignGap; break;
    case 112: statusValue = currentStatus.MAP10; break;
    case 113: statusValue = currentStatus.baro10; break;
    case 114: statusValue = misfireDetectionCount; break;
    case 115: statusValue = currentStatus.egoCorrection; break; //Exhaust gas correction (%)
    case 116: statusValue = lowByte(currentStatus.corrections2); break; //Total GammaE (%)
    case 117: statusValue = highByte(currentStatus.corrections2); break; //Total GammaE (%)
    case 118: statusValue = currentStatus.accelAdvance; break; //Accel Advance
...
uint8_t getLegacySecondarySerialLogEntry(uint16_t byteNum)
{
  ...
  switch(byteNum)
  {
    ...
    case 125: statusValue = currentStatus.accelAdvance; break; //Accel Advance
    /* [PJSC v1.10] Omitto Ari conditoner controll
...
bool is2ByteEntry(uint8_t key)
{
  ...
  static constexpr byte PROGMEM fsIntIndex[] = {4, 14, 17, 22, 26, 28, 33, 42, 44, 46, 48, 50, 52, 54, 56, 58, 60, 62, 64, 66, 68, 70, 72, 76, 78, 80, 82, 86, 88, 90, 93, 95, 99, 104, 111, 121, 124, 130, 136, 138, 140, 142, 144, 146, 148, 150, 152, 154, 156, 158, 160, 162, 164, 168 };  //[PJSC v1.10]
