...
byte getTSLogEntry(uint16_t byteNum)
{
  ...
  switch(byteNum)
  {
    ...
    case 112: statusValue = lowByte(currentStatus.fuelTemp + CALIBRATION_TEMPERATURE_OFFSET); break; //Fuel temperature from flex sensor
    ...
    case 117: statusValue = lowByte(currentStatus.EMAP); break; //2 bytes for EMAP
    case 118: statusValue = highByte(currentStatus.EMAP); break;
    case 119: statusValue = currentStatus.fanDuty; break;
    case 120: statusValue = lowByte(currentStatus.actualDwell); break;
    case 121: statusValue = highByte(currentStatus.actualDwell); break;
    case 122: statusValue = currentStatus.status5; break;
    case 123: statusValue = currentStatus.knockCount; break;
    case 124: statusValue = currentStatus.knockRetard; break;
    case 125: statusValue = currentStatus.PVPosition; break;
    case 126: statusValue = lowByte(currentStatus.PVPositionADC); break;
    case 127: statusValue = highByte(currentStatus.PVPositionADC); break;
    case 128: statusValue = currentStatus.inj1VE; break;
    case 129: statusValue = currentStatus.inj2VE; break;
    case 130: statusValue = currentStatus.inj3VE; break;
    case 131: statusValue = currentStatus.inj4VE; break;
    case 132: statusValue = lowByte(dutyFreq); break;
    case 133: statusValue = highByte(dutyFreq); break;
    case 134: statusValue = lowByte(dutyFreq2); break;
    case 135: statusValue = highByte(dutyFreq2); break;
    case 136: statusValue = lowByte(dutyRatio); break;
    case 137: statusValue = highByte(dutyRatio); break;
    case 138: statusValue = lowByte(dutyRatio2); break;
    case 139: statusValue = highByte(dutyRatio2); break;
    case 140: statusValue = lowByte(extTriggerAngle); break;
    case 141: statusValue = highByte(extTriggerAngle); break;
    case 142: statusValue = lowByte(extTriggerAngle2); break;
    case 143: statusValue = highByte(extTriggerAngle2); break;
    case 144: statusValue = lowByte(currentStatus.EGTADC); break;
    case 145: statusValue = highByte(currentStatus.EGTADC); break;
    case 146: statusValue = lowByte(currentStatus.fuelLoad3); break;
    case 147: statusValue = highByte(currentStatus.fuelLoad3); break;
    case 148: statusValue = lowByte(currentStatus.fuelLoad4); break;
    case 149: statusValue = highByte(currentStatus.fuelLoad4); break;
    case 150: statusValue = lowByte(extTriggerRPM); break;
    case 151: statusValue = highByte(extTriggerRPM); break;
    case 152: statusValue = lowByte(extTriggerLoad); break;
    case 153: statusValue = highByte(extTriggerLoad); break;
    case 154: statusValue = lowByte(currentStatus.testCnt); break;
...
int16_t getReadableLogEntry(uint16_t logIndex)
{
  ...
  switch(logIndex)
  {
    ...
    [PJSC v1.10] Omitto Ari conditoner controll */
   //****************** [PJSC v1.10] ******************
    case 78: statusValue = currentStatus.outputsStatus; break;
    case 79: statusValue = currentStatus.fuelTemp; break; //Fuel temperature from flex sensor
    case 80: statusValue = currentStatus.fuelTempCorrection; break; //Fuel temperature Correction (%)
    case 81: statusValue = currentStatus.advance1; break; //advance 1 (%)
    case 82: statusValue = currentStatus.advance2; break; //advance 2 (%)
    case 83: statusValue = currentStatus.TS_SD_Status; break; //SD card status
    case 84: statusValue = currentStatus.EMAP; break;
    case 85: statusValue = currentStatus.fanDuty; break;
    case 86: statusValue = currentStatus.actualDwell; break;
    case 87: statusValue = currentStatus.status5; break;
    case 88: statusValue = currentStatus.knockCount; break;
    case 89: statusValue = currentStatus.knockRetard; break;
    case 90: statusValue = currentStatus.PVPosition; break;
    case 91: statusValue = currentStatus.PVPositionADC; break;
    case 92: statusValue = currentStatus.inj1VE; break;
    case 93: statusValue = currentStatus.inj2VE; break;
    case 94: statusValue = currentStatus.inj3VE; break;
    case 95: statusValue = currentStatus.inj4VE; break;
    case 96: statusValue = dutyFreq; break;
    case 97: statusValue = dutyFreq2; break;
    case 98: statusValue = dutyRatio; break;
    case 99: statusValue = dutyRatio2; break;
    case 100: statusValue = extTriggerAngle; break;
    case 101: statusValue = extTriggerAngle2; break;
    case 102: statusValue = currentStatus.EGTADC; break;
    case 103: statusValue = currentStatus.fuelLoad3; break;
    case 104: statusValue = currentStatus.fuelLoad4; break;
    case 105: statusValue = extTriggerRPM; break;
