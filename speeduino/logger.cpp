...
byte getTSLogEntry(uint16_t byteNum)
{
  ...
  switch(byteNum)
  {
    ...
    case 136: statusValue = lowByte(currentStatus.dutyFreq); break;
    case 137: statusValue = highByte(currentStatus.dutyFreq); break;
    case 138: statusValue = lowByte(currentStatus.dutyFreq2); break;
    case 139: statusValue = highByte(currentStatus.dutyFreq2); break;
    case 140: statusValue = lowByte(currentStatus.dutyRatio); break;
    case 141: statusValue = highByte(currentStatus.dutyRatio); break;
    case 142: statusValue = lowByte(currentStatus.dutyRatio2); break;
    case 143: statusValue = highByte(currentStatus.dutyRatio2); break;
    case 144: statusValue = lowByte(currentStatus.extTriggerAngle); break;
    case 145: statusValue = highByte(currentStatus.extTriggerAngle); break;
    case 146: statusValue = lowByte(currentStatus.extTriggerAngle_last); break;
    case 147: statusValue = highByte(currentStatus.extTriggerAngle_last); break;
    case 148: statusValue = lowByte(currentStatus.extTriggerAngle2); break;
    case 149: statusValue = highByte(currentStatus.extTriggerAngle2); break;
    case 150: statusValue = lowByte(currentStatus.extTriggerAngle_last2); break;
    case 151: statusValue = highByte(currentStatus.extTriggerAngle_last2); break;
    case 152: statusValue = lowByte(currentStatus.EGTADC); break;
    case 153: statusValue = highByte(currentStatus.EGTADC); break;
    case 154: statusValue = lowByte(currentStatus.fuelLoad3); break;
    case 155: statusValue = highByte(currentStatus.fuelLoad3); break;
    case 156: statusValue = lowByte(currentStatus.fuelLoad4); break;
    case 157: statusValue = highByte(currentStatus.fuelLoad4); break;
    case 158: statusValue = lowByte(currentStatus.extTriggerRPM); break;
    case 159: statusValue = highByte(currentStatus.extTriggerRPM); break;
    case 160: statusValue = lowByte(currentStatus.extTriggerLoad); break;
    case 161: statusValue = highByte(currentStatus.extTriggerLoad); break;
    case 162: statusValue = lowByte(currentStatus.testCnt); break;
    case 163: statusValue = highByte(currentStatus.testCnt); break;
    case 164: statusValue = lowByte(ignGap); break;
    case 165: statusValue = highByte(ignGap); break;
    case 166: statusValue = lowByte((int)(currentStatus.MAP10)); break;
    case 167: statusValue = highByte((int)(currentStatus.MAP10)); break;
...
int16_t getReadableLogEntry(uint16_t logIndex)
{
  ...
  switch(logIndex)
  {
   ...
   //****************** [PJSC v1.10] ******************
    ...
    case 99: statusValue = currentStatus.dutyFreq; break;
    case 100: statusValue = currentStatus.dutyFreq2; break;
    case 101: statusValue = currentStatus.dutyRatio; break;
    case 102: statusValue = currentStatus.dutyRatio2; break;
    case 103: statusValue = currentStatus.extTriggerAngle; break;
    case 104: statusValue = currentStatus.extTriggerAngle_last; break;
    case 105: statusValue = currentStatus.extTriggerAngle2; break;
    case 106: statusValue = currentStatus.extTriggerAngle_last2; break;
    case 107: statusValue = currentStatus.EGTADC; break;
    case 108: statusValue = currentStatus.fuelLoad3; break;
    case 109: statusValue = currentStatus.fuelLoad4; break;
    case 110: statusValue = currentStatus.extTriggerRPM; break;
    case 111: statusValue = currentStatus.extTriggerLoad; break;
    case 112: statusValue = currentStatus.testCnt; break;
    case 113: statusValue = ignGap; break;
