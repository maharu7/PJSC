...
#define PJSC_v110                       //[PJSC v1.10]
  ...
  #endif
  #ifndef IGN_CHANNELS
    #if defined(PJSC_v110)                  //[PJSC v1.10]
      #define IGN_CHANNELS 4                //[PJSC v1.10]
    #else                                   //[PJSC v1.10]
...
//#define FRAM_AS_EEPROM /*Use FRAM like FM25xxx, MB85RSxxx or any SPI compatible */
  ...
  //***** [PJSC v1.10] Use M25Qxx SPI flash by DevEBox STM32F407VET6 *****
  #if defined(ARDUINO_BLACK_F407VE)
    #define USE_SPI_EEPROM PA15 
  #elif defined(ARDUINO_DevEBoxH743VITX)
    #define USE_SPI_EEPROM PB6
  #endif
  //***** [PJSC v1.10] Use M25Qxx SPI flash by DevEBox STM32F407VET6 *****
...
#define FUEL2_CONDITION_GEAR 4     //[PJSC v1.10]
...
#define BIT_TEST_MUX1             0  //MUX output1
#define BIT_TEST_MUX2             1  //MUX output2
#define BIT_TEST_MUX3             2  //MUX output3
#define BIT_TEST_MUX4             3  //MUX output4
#define BIT_TEST_FP               4  //Fuel pump output
#define BIT_TEST_MUXHC            5  //MUX output High Current

//Define argument for Injector channel
...
#define CH_MUXHC                  10 //MUX output for High Current
#define CH_MUX3                   11 //MUX output3
#define CH_MUX4                   12 //MUX output4
...
#define EXTRIG_SPARK_DISABLE      0
#define EXTRIG_SPARK_CAPTURE      1
#define EXTRIG_MAP_SELECT         2
#define EXTRIG_MISFIRE_DETECTION  3
#define EXTRIG_VIECLE_SPEED       4
#define EXTRIG_PWM_CAPT           5
#define EXTRIG_SMART_SHIFT        6

#define DIGITAL_INPUT2_DISABLE    0
#define DIGITAL_INPUT2_PWM_CAPT   1
#define DIGITAL_INPUT2_SHIFT      2

#define MUXOUT_OFF                0
#define MUXOUT_IDLE               1
#define MUXOUT_FAN                2
#define MUXOUT_LAUNCH             3
#define MUXOUT_FUELPUMP           4
#define MUXOUT_BOOST              5
#define MUXOUT_VVT                6
#define MUXOUT_VVT2               7
#define MUXOUT_TACH               8
#define MUXOUT_WMI                9
#define MUXOUT_OILSOLENOID       10
#define MUXOUT_STARTER           11

#define ANALOG_INPUT_OFF          0
#define ANALOG_EXVALVE            1
#define ANALOG_O2_SEC             2
#define ANALOG_BARO               1
#define ANALOG_EGT                2

#define TEST_OP_OFF               0
#define TEST_OP_ONE               1
#define TEST_OP_ALL               3
...
struct config10 {
  ...
  //[PJSC v1.10]byte unused11_165 : 3;
  byte spark2SwitchVariable : 3;  //[PJSC v1.10]
  ...
  byte spark2Mode : 3;
  //[PJSC v1.10]byte spark2SwitchVariable : 2;
  byte unused10_186 : 2;   //[PJSC v1.10]
...
struct config15 {
  ...
  //Bytes 106-255
//[PJSC v1.10]  byte Unused15_106_255[150];
//****************************** [PJSC v1.10] ******************************
  byte pjscFreq;                     //91
  ...
  byte exTrigModeSelect2: 3;
  byte externalTrigEdge2: 1;
  ...
  byte crankingFilter: 1;
  byte dfcoTPSdotEnabled: 1;
  byte isolateNumTooth: 1;
  byte triggerWheelSelectable: 1;

  byte swASE: 1;                     //98
  byte swIATcorrection: 1;
  byte swAE: 1;
  byte swWUE: 1;
  byte swCrankingEnrichment: 1;
  byte swBatVCorrection: 1;
  byte swFuelTempCorrection: 1;
  byte swLaunchCorrection: 1;

  byte veMapSelectionInj1Pri: 4;     //99
  byte veMapSelectionInj1Sec: 4;
  byte veMapSelectionInj2Pri: 4;     //100
  byte veMapSelectionInj2Sec: 4;
  byte veMapSelectionInj3Pri: 4;     //101
  byte veMapSelectionInj3Sec: 4;
  byte veMapSelectionInj4Pri: 4;     //102
  byte veMapSelectionInj4Sec: 4;
  byte veMapSelectionInj1_2Pri: 4;   //103
  byte veMapSelectionInj1_2Sec: 4;
  byte veMapSelectionInj2_2Pri: 4;   //104
  byte veMapSelectionInj2_2Sec: 4;
  byte veMapSelectionInj3_2Pri: 4;   //105
  ...
  byte afr_sensor_selection1: 1;
  byte afr_sensor_selection2: 1;
...
//****************************** [PJSC v1.10] ******************************
extern byte pinEGT;
extern byte pinExtTrigger;
extern byte pinExValve;
extern byte pinCaptureDuty1;
extern byte pinCaptureDuty2;
extern byte pinMuxout1;
extern byte pinMuxout2;
extern byte pinMuxout3;
extern byte pinMuxout4;
extern byte pinMuxoutHC;
extern byte pinAnalogInput1;
extern byte pinAnalogInput2;
extern byte pinPvDIR;               //[PJSC v1.10] For PV control
extern byte pinPvPWM;               //[PJSC v1.10] For PV control
extern byte pinPvDIS;               //[PJSC v1.10] For PV control
extern byte pinOilSolenoid;         //[PJSC v1.10] For Oil Solenoid control
extern byte pinStarter;             //[PJSC v1.10]
//****************************** [PJSC v1.10] ******************************
