...
struct table2D acclAdvTable; //[PJSC v1.10] 5 bin TPS Acceleration Advance map (2D)
...
byte pinExtTrigger;
byte pinExValve;
byte pinCaptureDuty1;
byte pinCaptureDuty2;
byte pinMuxout1;
byte pinMuxout2;
byte pinMuxout3;
byte pinMuxout4;
byte pinMuxoutHC;
byte pinAnalogInput1;
byte pinAnalogInput2;
byte pinPvDIR;               //[PJSC v1.10] For PV control
byte pinPvPWM;               //[PJSC v1.10] For PV control
byte pinPvDIS;               //[PJSC v1.10] For PV control
byte pinOilSolenoid;         //[PJSC v1.10] For Oil Solenoid control
byte pinStarter;             //[PJSC v1.10]
//****************************** [PJSC v1.10] ******************************
...
//*************** [PJSC v1.10] ***************
//[PJSC v1.10tmp]uint16_t spareThermCalibration_bins[32];
//[PJSC v1.10tmp]uint16_t spareThermCalibration_values[32];
//[PJSC v1.10tmp]struct table2D spareThermCalibrationTable;
//[PJSC v1.10tmp]uint16_t o2SecCalibration_bins[32];
//[PJSC v1.10tmp]uint8_t  o2SecCalibration_values[32];
//[PJSC v1.10tmp]struct table2D o2SecCalibrationTable;
//*************** [PJSC v1.10] ***************
