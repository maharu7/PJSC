...
#endif
  {
    if ( (configPage15.squirtDeviceTypeCh1 == 1) || BIT_CHECK(currentStatus.testMode, BIT_TEST_PWM) || BIT_CHECK(currentStatus.testMode, BIT_TEST_PULSE) ) { pjsc1Toggle(); } //[PJSC v1.10]The interrupt to control the PJSC PWM
    else                                                                                                                                                                      //[PJSC v1.10]
    {                                                                                                                                                                         //[PJSC v1.10]
...
#endif
  {
    if ( (configPage15.squirtDeviceTypeCh2 == 1) || BIT_CHECK(currentStatus.testMode, BIT_TEST_PWM) || BIT_CHECK(currentStatus.testMode, BIT_TEST_PULSE) ) { pjsc2Toggle(); } //[PJSC v1.10]The interrupt to control the PJSC PWM
    else                                                                                                                                                                      //[PJSC v1.10]
    {                                                                                                                                                                         //[PJSC v1.10]
...
#endif
  {
    if ( (configPage15.squirtDeviceTypeCh3 == 1) || BIT_CHECK(currentStatus.testMode, BIT_TEST_PWM) || BIT_CHECK(currentStatus.testMode, BIT_TEST_PULSE) ) { pjsc3Toggle(); } //[PJSC v1.10]The interrupt to control the PJSC PWM
    else                                                                                                                                                                      //[PJSC v1.10]
    {                                                                                                                                                                         //[PJSC v1.10]
...
#endif
  {
    if ( (configPage15.squirtDeviceTypeCh4 == 1) || BIT_CHECK(currentStatus.testMode, BIT_TEST_PWM) || BIT_CHECK(currentStatus.testMode, BIT_TEST_PULSE) ) { pjsc4Toggle(); } //[PJSC v1.10]The interrupt to control the PJSC PWM
    else                                                                                                                                                                      //[PJSC v1.10]
    {                                                                                                                                                                         //[PJSC v1.10]
...
#endif
  {
    if ( BIT_CHECK(currentStatus.testModeActive, BIT_TEST_IGN1) && (BIT_CHECK(currentStatus.testMode, BIT_TEST_PWM) || BIT_CHECK(currentStatus.testMode, BIT_TEST_PULSE)) ) { ign1Toggle(); } //[PJSC v1.10]The interrupt to control the PJSC PWM
    else                                                                                                                                                                                    //[PJSC v1.10]
    {                                                                                                                                                                                       //[PJSC v1.10]
...
#endif
  {
    if ( BIT_CHECK(currentStatus.testModeActive, BIT_TEST_IGN2) && (BIT_CHECK(currentStatus.testMode, BIT_TEST_PWM) || BIT_CHECK(currentStatus.testMode, BIT_TEST_PULSE)) ) { ign2Toggle(); } //[PJSC v1.10]The interrupt to control the PJSC PWM
    else                                                                                                                                                                                    //[PJSC v1.10]
    {                                                                                                                                                                                       //[PJSC v1.10]
...
#endif
  {
    if ( BIT_CHECK(currentStatus.testModeActive, BIT_TEST_IGN3) && (BIT_CHECK(currentStatus.testMode, BIT_TEST_PWM) || BIT_CHECK(currentStatus.testMode, BIT_TEST_PULSE)) ) { ign3Toggle(); } //[PJSC v1.10]The interrupt to control the PJSC PWM
    else                                                                                                                                                                                    //[PJSC v1.10]
    {                                                                                                                                                                                       //[PJSC v1.10]
...
#endif
  {
    if ( BIT_CHECK(currentStatus.testModeActive, BIT_TEST_IGN4) && (BIT_CHECK(currentStatus.testMode, BIT_TEST_PWM) || BIT_CHECK(currentStatus.testMode, BIT_TEST_PULSE)) ) { ign4Toggle(); } //[PJSC v1.10]The interrupt to control the PJSC PWM
    else                                                                                                                                                                                    //[PJSC v1.10]
    {                                                                                                                                                                                       //[PJSC v1.10]
