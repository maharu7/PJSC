...
void calculateStagingPW(uint16_t PW, int injOpenPrim, int injOpenSecond, unsigned long pwLimit);      //[PJSC v1.10]
...
extern uint16_t inj2_opentime_uS;       //[PJSC v1.10]
extern uint16_t inj3_opentime_uS;       //[PJSC v1.10]
extern uint16_t inj4_opentime_uS;       //[PJSC v1.10]
extern uint16_t primaryPW;              //[PJSC v1.10]
extern uint16_t secondaryPW;            //[PJSC v1.10]
extern uint16_t primaryPW_2;            //[PJSC v1.10]
extern uint16_t secondaryPW_2;          //[PJSC v1.10]
