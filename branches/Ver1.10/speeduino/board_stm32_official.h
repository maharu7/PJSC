...
#include <SPI.h>
  ...
  #endif
#elif defined(STM32H7)                   //[PJSC v1.10]
#include "stm32h7xx_ll_tim.h"            //[PJSC v1.10]
...
void jumpToBootloader();
 ...
 || defined(ARDUINO_BLACKPILL_F401CC) || defined(ARDUINO_BLACKPILL_F411CE)
  ...
  //Hack to allow compilation on small STM boards
    ...
    #define A15  PA5
  #endif
#elif defined(ARDUINO_BLUE_F407VE_MINI)                                                                                                                                                 //[PJSC v1.10]
    #define pinIsReserved(pin)  ( ((pin) == PA11) || ((pin) == PA12) || ((pin) == PB6) || ((pin) == PB7) )                                                                              //[PJSC v1.10] Forbidden pins like USB and EEPROM
#elif defined(ARDUINO_DevEBoxH743VITX)                                                                                                                                                  //[PJSC v1.10]
    #define pinIsReserved(pin)  ( ((pin) == PA11) || ((pin) == PA12) || ((pin) == PB2) || ((pin) == PD11) || ((pin) == PD12) || ((pin) == PD13) || ((pin) == PE2) || ((pin) == PB6) )   //[PJSC v1.10]
#else
  #ifdef USE_SPI_EEPROM
    #define pinIsReserved(pin)  ( ((pin) == PA11) || ((pin) == PA12) || ((pin) == PB3) || ((pin) == PB4) || ((pin) == PB5) || ((pin) == USE_SPI_EEPROM) ) //Forbidden pins like USB
  #else
//[PJSC v1.10]    #define pinIsReserved(pin)  ( ((pin) == PA11) || ((pin) == PA12) || ((pin) == PB3) || ((pin) == PB4) || ((pin) == PB5) || ((pin) == PB0) ) //Forbidden pins like USB
    #define pinIsReserved(pin)  ( ((pin) == PA11) || ((pin) == PA12) || ((pin) == PB3) || ((pin) == PB4) || ((pin) == PB5) || ((pin) == PA15) )           //[PJSC v1.10] For like STM Pro ECU
  #endif
#endif
