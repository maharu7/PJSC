...
#define ADCFILTER_EGT_DEFAULT   50U //[PJSC v1.10]
#define ADCFILTER_PV_DEFAULT    50U //[PJSC v1.10]
...
void readBat(void);
void readBaro(void);
void readPVPosition(bool useFilter=true);  //[PJSC] For External Trigger
void readEGT(void);                        //[PJSC v1.03] For Exhaust Gas Temperature sennsor
