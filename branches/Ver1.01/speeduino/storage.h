...
| 1884  |2    | X and Y sizes for VE2 table         |[PJSC]
| 1886  |256  | VE Map (16x16)                      | |
| 2142  |16   | VE Table RPM bins                   | V
| 2158  |16   | VE Table MAP/TPS bins               |[PJSC]
|                                                   |
...
/* [PJSC v1.01] Change EEPROM layout for preparing VE table 4 support
...
#define EEPROM_CONFIG12_XSIZE 2094 //[PJSC]
#define EEPROM_CONFIG12_YSIZE 2095 // |
#define EEPROM_CONFIG12_MAP   2096 // |
#define EEPROM_CONFIG12_XBINS 2352 // |
#define EEPROM_CONFIG12_YBINS 2368 // V
#define EEPROM_CONFIG12_END   2384 //[PJSC]
*/

//=============================================
//[PJSC v1.01] New EEPROM layout for preparing VE table 4 support
#define EEPROM_CONFIG9_START  1501
#define EEPROM_CONFIG9_END    1693
#define EEPROM_CONFIG10_START 1693
#define EEPROM_CONFIG10_END   1885
#define EEPROM_CONFIG11_XSIZE 1885
#define EEPROM_CONFIG11_YSIZE 1886
#define EEPROM_CONFIG11_MAP   1887
#define EEPROM_CONFIG11_XBINS 2143
#define EEPROM_CONFIG11_YBINS 2159
#define EEPROM_CONFIG11_END   2175
#define EEPROM_CONFIG12_XSIZE 2175
#define EEPROM_CONFIG12_YSIZE 2176
#define EEPROM_CONFIG12_MAP   2177
#define EEPROM_CONFIG12_XBINS 2433
#define EEPROM_CONFIG12_YBINS 2449
#define EEPROM_CONFIG12_END   2465
//=============================================

//Calibration data is stored at the end of the EEPROM (This is in case any further calibration tables are needed as they are large blocks)
//[PJSC ver1.10]#define EEPROM_LAST_BARO      2558
#define EEPROM_LAST_BARO      2557  //[PJSC ver1.10]
